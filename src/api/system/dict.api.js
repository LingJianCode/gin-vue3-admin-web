...
const DICT_ITEM_BASE_URL = "/api/v1/dict";
...
const DictAPI = {
  ...
  getDictItemPage(dictCode, queryParams) {
    return request({
      url: `${DICT_ITEM_BASE_URL}/${dictCode}/items/page`,
      method: "get",
      params: queryParams,
    });
  },
  ...
  getDictItems(dictCode) {
    return request({
      url: `${DICT_ITEM_BASE_URL}/${dictCode}/items`,
      method: "get",
    });
  },
  ...
  getDictItemFormData(dictCode, id) {
    return request({
      url: `${DICT_ITEM_BASE_URL}/${dictCode}/items/${id}/form`,
      method: "get",
    });
  },
  ...
  updateDictItem(dictCode, id, data) {
    return request({
      url: `${DICT_ITEM_BASE_URL}/${dictCode}/items/${id}`,
      method: "put",
      data: data,
    });
  },
  ...
  deleteDictItems(dictCode, ids) {
    return request({
      url: `${DICT_ITEM_BASE_URL}/${dictCode}/items/${ids}`,
      method: "delete",
    });
  },
};
